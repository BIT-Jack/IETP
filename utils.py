...
class ngsimDataset(Dataset):
    ...
    def getHistory(self,vehId,t,refVehId,dsId):
        if vehId == 0:
            ...
            refPos = refTrack[np.where(refTrack[:,0]==t)][0,1:3] #refPos存储的是refVeh的 x 和 y用于算相对位置的 
            ...
            if vehTrack.size==0 or np.argwhere(vehTrack[:, 0] == t).size==0:
                ...
                hist = vehTrack[stpt:enpt:self.d_s,1:3]-refPos             #vehTrack存储历史3秒跨度内的相对坐标
    ...
    def getFuture(self, vehId, t,dsId):
        ...
        fut = vehTrack[stpt:enpt:self.d_s,1:3]-refPos              #同理，存的也是相对于主车的未来轨迹真实坐标
        return fut
